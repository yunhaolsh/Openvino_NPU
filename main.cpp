...
int tmain(int argc, tchar* argv[]) {
    ...
    try {
        ...
        ov::PartialShape input_shapeT = model.get()->input().get_partial_shape();
        input_shapeT[0] = 1;
        input_shapeT[2] = 224;
        input_shapeT[3] = 224;
        model.get()->reshape(input_shapeT);

        ov::PartialShape new_shape = model->input().get_partial_shape();
        slog::info << "New input shape: " << new_shape << slog::endl;
